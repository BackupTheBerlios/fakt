<?PHP
/*
 | Configuration parameters for FAKT system
 |
...
$timeoffset = 7;	/* in case we are not in the same time zone */
...
<A HREF=$scriptsurl/index.php><IMG src=doc_open.gif border=0><FONT color=white><BIG>
רשימת הפורומים</A>
</TABLE>
</CENTER>
EOD;
