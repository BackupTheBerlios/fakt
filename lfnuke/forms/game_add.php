...
<br>
<form enctype="multipart/form-data" action="../add/game.php" method="post" id="artwork_form"
 target="_self">
 ...
 name="game_name" size="45" maxlenght="45"></td>
      ...
      <tr>
        <td style="vertical-align: top; text-align: right; width: 5 px;">תיאור:<br>
        </td>
        <td style="vertical-align: top; text-align: right;"><textarea
 name="game_desc" rows="3" cols="45"></textarea></td>
      </tr>
      <tr>
        <td style="vertical-align: top; text-align: right; width: 5 px;">תמונה:<br>
        </td>
 ...
 name="game_home" size="45" maxlenght="45"></td>
      ...
      <tr>
        <td style="vertical-align: top; text-align: right; width: 5 px;">קטגוריה:<br>
        </td>
        <td style="vertical-align: top; text-align: right;">
